...
export const INACTIVE_TOL_TIME = 300000;
export const MAX_INACTIVE_TOL_TIME = 600000;
export const MIN_INACTIVE_TOL_TIME = 60000;

export const INACTIVE_TOL_DIST = 0.05; 
